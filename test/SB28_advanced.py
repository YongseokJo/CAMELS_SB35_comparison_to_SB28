...
train_loader = DataLoader(train_aug, batch_size=batch_size, shuffle=True)#, pin_memory=True)
val_loader   = DataLoader(val_aug,   batch_size=batch_size, shuffle=False)#, pin_memory=True)
